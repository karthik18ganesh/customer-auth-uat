...
async function sendSMSviaSNS(phoneNumber, passCode) {
    const params = { "Message": `Use OTP ${passCode} to login to your Cookr Account. Cookr doesn't ask for OTP or Contact number to be shared with anyone including Cookr Personnel. jCO+K9xa87G`, "PhoneNumber": phoneNumber };
